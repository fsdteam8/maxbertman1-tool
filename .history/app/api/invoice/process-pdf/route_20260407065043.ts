...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log(
      "[API] Text extracted, length:",
      extractedContent.rawText.length,
    );
