      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-sm font-black uppercase tracking-[0.2em] text-foreground">PO Resolution</h3>
          </div>
          ...
          {detected ? (
            ...
            <Badge variant="secondary" className="bg-white/5 text-muted-foreground border-white/10 px-3 py-1">
          ...
          <div className="space-y-3">
            ...
            {poNumber && detected && (
              <p className="text-xs text-primary font-medium animate-fade-in pl-1">
                The placeholder will be replaced with <span className="font-bold">PO# {poNumber}</span> in the final PDF.
              </p>
            )}
            
            {!detected && (
              <p className="text-[10px] text-muted-foreground italic pl-1 leading-relaxed">
                No standard PO placeholder was detected automatically. You can still provide a PO number here to resolve it if it was missed, or for your records.
              </p>
            )}
          </div>
        </div>
