...
/**
 * Replace both PO# and W.O# tokens in a single pass - W.O. DISABLED
 * W.O. features are currently disabled. Only handles PO# tokens.
 */
export function replacePOWOTokens(
  ...
  // Only handle PO# tokens - W.O. disabled
